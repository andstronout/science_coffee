...
if (isset($_POST["submit"])) {
  ...
  if (@$_FILES['produk']['error'] > 0) {
    ...
    echo "
      <script>
      alert('Silahkan Upload Gambar Produk!');
      </script>
      ";
  } else {
              ...
              <form action="" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                  ...
                  <select class="form-select" name="jenis" required>
                    <option selected value="<?= $produk['jenis']; ?>"><?= $produk['jenis']; ?></option>
                ...
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control" id="qty_produk" name="qty_produk" placeholder="Qty Produk" required value="<?= $produk['qty_produk']; ?>">
                </div>
                <div class="mb-3">
