                      ...
                      <tr>
                        ...
                        <td>
                          <?php if ($transaksi['status'] == 'Belum Diproses') { ?>
                            <a href="detail_transaksi.php?id=<?= $transaksi['id_transaksi']; ?>" class="btn btn-secondary btn-sm">
                              <span class="text">Proses Transaksi</span>
                            </a>
                          <?php } elseif ($transaksi['status'] == 'Sedang Diproses') { ?>
                            <a href="detail_transaksi.php?id=<?= $transaksi['id_transaksi']; ?>" class="btn btn-warning btn-sm">
                              <span class="text">Proses Transaksi</span>
                            </a>
                          <?php } else { ?>
