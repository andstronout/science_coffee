      ...
      <div class="container">
        <div class="row slider-text justify-content-center align-items-center">
          ...
          <div class="col-md-7 col-sm-12 text-center ftco-animate">
            <h1 class="mb-3 mt-5 bread">Edit Profil</h1>
    ...
    <div class="container mt-5">
      <div class="row block-9">
        <div class="col-md-6 ftco-animate mx-auto text-center">
          <h4 class="mb-3">Edit Your Profil</h4>
          <form action="#" method="POST" class="contact-form">
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  <input type="text" class="form-control" placeholder="Your Name" value="<?= $query['nama_user']; ?>" name="nama_user">
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group">
                  <input type="text" class="form-control" placeholder="Your Email" value="<?= $query['email']; ?>" disabled>
                </div>
              </div>
            </div>
            <div class="form-group">
              <input type="number" value="<?= $query['nomor_hp']; ?>" onkeypress="return (event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 57))" name="nomor_hp" class="form-control" placeholder="Nomor Handphone">
            </div>
            <div class="form-group">
