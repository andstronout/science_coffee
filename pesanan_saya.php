...
$sql = $conn->query("SELECT * FROM transaksi WHERE id_user='$id' AND `status`='Belum Diproses'");
?>
              ...
              <tbody>
                ...
                if ($sql->num_rows > 0) {
                  foreach ($sql as $transaksi) { ?>
                    ...
                    <?php
                    $sql_detail = $conn->query("SELECT * FROM detail_transaksi INNER JOIN transaksi ON detail_transaksi.id_transaksi=transaksi.id_transaksi INNER JOIN produk ON detail_transaksi.id_produk=produk.id_produk WHERE id_user='$_SESSION[id_pelanggan]' AND `status`='Belum Diproses' AND transaksi.id_transaksi='$transaksi[id_transaksi]'");
