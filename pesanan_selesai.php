...
$sql = $conn->query("SELECT * FROM transaksi WHERE id_user='$id' AND `status`='Selesai Diproses'");
?>
  ...
  <section class="ftco-section ftco-cart">
    <div class="container">
      ...
      <div class="row d-flex justify-content-center mb-4">
        ...
        <div class="col-md-3">
          <a href="pesanan_diproses.php" class="btn btn-primary btn-outline-primary" style="height: 45px;">
              ...
              <tbody>
                ...
                if ($sql->num_rows > 0) {
                  foreach ($sql as $transaksi) { ?>
                    ...
                    <?php
                    $sql_detail = $conn->query("SELECT * FROM detail_transaksi INNER JOIN transaksi ON detail_transaksi.id_transaksi=transaksi.id_transaksi INNER JOIN produk ON detail_transaksi.id_produk=produk.id_produk WHERE id_user='$_SESSION[id_pelanggan]' AND `status`='Selesai Diproses' AND transaksi.id_transaksi='$transaksi[id_transaksi]'");
